...
const val ANDROID_PLUGIN = "com.android.tools.build:gradle:3.6.0-alpha04"
...
const val KTX = "androidx.core:core-ktx:1.1.0-beta01"
const val ACTIVITYX = "androidx.activity:activity-ktx:1.0.0-beta01"
const val FRAGMENTX = "androidx.fragment:fragment-ktx:1.1.0-beta01"
